    ...
    class Cookies
      module SubStore
        ...
        class Signed < Base
          ...
          # Returns the value matching the passed signed cookie name, or the `default` one if the cookie is not present.
          ...
          # as the cookie value. Apart from the cookie name and value, this method allows to define some additional
          # cookie properties:
          #
