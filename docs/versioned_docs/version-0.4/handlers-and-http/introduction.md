...
| `#headers` | Returns a hash-like object (instance of [`Marten::HTTP::Headers`](pathname:///api/0.4/Marten/HTTP/Headers.html)) containg the headers that will be used for the response. |
