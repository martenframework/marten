...
<div className="row category-index-row">
  ...
  <article key="generators" className="col col--6">
    <DocCard item={{type: "link", href: "./development/generators", label: "Generators", docId: "development/generators" }} />
  </article>
...
<div className="row category-index-row">
  ...
  <article key="generators" className="col col--6">
    <DocCard item={{type: "link", href: "./development/reference/generators", label: "Generators", docId: "development/reference/generators" }} />
  </article>
</div>
