...
describe Marten::HTTP::Cookies::SubStore::Signed do
  describe "#fetch" do
    it "allows to retrieve a specific signed cookie value using its name" do
      sub_store = Marten::HTTP::Cookies::SubStore::Signed.new(Marten::HTTP::Cookies.new)
  ...
  describe "#set" do
    it "allows to set a simple cookie using a cookie name string" do
      ...
      sub_store = Marten::HTTP::Cookies::SubStore::Signed.new(cookies)
