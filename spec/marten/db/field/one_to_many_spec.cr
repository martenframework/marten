...
describe Marten::DB::Field::OneToMany do
  ...
  describe "#to_column" do
    it "returns the expected column" do
      field = Marten::DB::Field::OneToMany.new("tag_id", "tag", Tag, db_column: "origin_tag_id")
