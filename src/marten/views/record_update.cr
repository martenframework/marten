...
module Marten
  module Views
    ...
    #
    # This view can be used to process a form, validate its data through the use of a schema, and update an existing
    # record by using the validated data. It is expected that the view will be accessed through a GET request first:
    ...
    # model record that was retrieved is updated and the view returns an HTTP redirect to a configured success URL.
    #
    # ```
