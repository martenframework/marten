...
This method returns a [`Marten::DB::Query::RawSet`](pathname:///api/0.3/Marten/DB/Query/RawSet.html) object, which allows to iterate over the model records matched by the passed SQL query. For example:
