...
**Class:** [`Marten::Middleware::ContentSecurityPolicy`](pathname:///api/0.7/Marten/Middleware/ContentSecurityPolicy.html)
...
**Class:** [`Marten::Middleware::CrossOriginOpenerPolicy`](pathname:///api/0.7/Marten/Middleware/CrossOriginOpenerPolicy.html)
...
You can also define a custom header value on a per-handler basis by using the [`#cross_origin_opener_policy`](pathname:///api/0.7/Marten/Handlers/CrossOriginOpenerPolicy/ClassMethods.html#cross_origin_opener_policy(value%3AString%7CSymbol)%3ANil-instance-method) class method:
...
It is also possible to disable the header entirely on a per-handler basis by using the [`#exempt_from_cross_origin_opener_policy`](pathname:///api/0.7/Marten/Handlers/CrossOriginOpenerPolicy/ClassMethods.html#exempt_from_cross_origin_opener_policy(exempt%3ABool)%3ANil-instance-method) class method:
...
**Class:** [`Marten::Middleware::Flash`](pathname:///api/0.7/Marten/Middleware/Flash.html)
...
The flash store depends on the presence of a working session store. As such, the [Session middleware](#session-middleware) MUST be used along with this middleware. Moreover, this middleware must be placed _after_ the [`Marten::Middleware::Session`](pathname:///api/0.7/Marten/Middleware/Session.html) in the [`middleware`](../../development/reference/settings.md#middleware) setting.

## GZip middleware

**Class:** [`Marten::Middleware::GZip`](pathname:///api/0.7/Marten/Middleware/GZip.html)
...
**Class:** [`Marten::Middleware::I18n`](pathname:///api/0.7/Marten/Middleware/I18n.html)
...
**Class:** [`Marten::Middleware::MethodOverride`](pathname:///api/0.7/Marten/Middleware/MethodOverride.html)
...
**Class:** [`Marten::Middleware::ReferrerPolicy`](pathname:///api/0.7/Marten/Middleware/ReferrerPolicy.html)
...
**Class:** [`Marten::Middleware::Session`](pathname:///api/0.7/Marten/Middleware/Session.html)
...
**Class:** [`Marten::Middleware::SSLRedirect`](pathname:///api/0.7/Marten/Middleware/SSLRedirect.html)
...
**Class:** [`Marten::Middleware::StrictTransportSecurity`](pathname:///api/0.7/Marten/Middleware/StrictTransportSecurity.html)
...
**Class:** [`Marten::Middleware::XContentTypeOptions`](pathname:///api/0.7/Marten/Middleware/XContentTypeOptions.html)
...
It should be noted that you can decide to disable or enable the use of this middleware on a per-handler basis. To do so, you can simply make use of the [`#exempt_from_x_content_type_options`](pathname:///api/0.7/Marten/Handlers/XContentTypeOptions/ClassMethods.html#exempt_from_x_content_type_options(exempt%3ABool)%3ANil-instance-method) class method, which takes a single boolean as argument:
...
**Class:** [`Marten::Middleware::XFrameOptions`](pathname:///api/0.7/Marten/Middleware/XFrameOptions.html)
