  ...
  module Views
    ...
    module XFrameOptions
      macro included
        ...
        extend Marten::Views::XFrameOptions::ClassMethods

        after_dispatch :apply_x_frame_options_exemption
      end

      module ClassMethods
        # Allows to define whether or not the view responses should be exempted from using X-Frame-Options.
        #
        ...
        # Returns a boolean indicating if the view is exempted from using X-Frame-Options.
