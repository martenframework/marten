...
Uploaded files are made available in the [`#data`](pathname:///api/0.7/Marten/HTTP/Request.html#data%3AParams%3A%3AData-instance-method) hash-like object of any HTTP request object (instance of [`Marten::HTTP::Request`](pathname:///api/0.7/Marten/HTTP/Request.html)). These file objects are instances of the [`Marten::HTTP::UploadedFile`](pathname:///api/0.7/Marten/HTTP/UploadedFile.html) class.
...
[`Marten::HTTP::UploadedFile`](pathname:///api/0.7/Marten/HTTP/UploadedFile.html) objects give you access to the following key methods, which allow you to interact with the uploaded file and its content:
