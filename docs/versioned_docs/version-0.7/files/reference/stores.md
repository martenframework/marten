...
This file storage is implemented as part of the [`Marten::Core::Storage::FileSystem`](pathname:///api/0.7/Marten/Core/Storage/FileSystem.html) class. It ensures that files are persisted in the local file system, where the Marten application is running.
