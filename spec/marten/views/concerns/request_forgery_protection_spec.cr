...
describe Marten::Views::RequestForgeryProtection do
  around_each do |t|
  ...
  describe "::protect_from_forgery" do
    it "can enable CSRF protection" do
      Marten::Views::RequestForgeryProtectionSpec::TestViewWithProtectionEnabled.protect_from_forgery?.should be_true
    end

    it "can disable CSRF protection" do
      Marten::Views::RequestForgeryProtectionSpec::TestViewWithProtectionDisabled.protect_from_forgery?.should be_false
    end
  end

  describe "::protect_from_forgery?" do
    it "returns true if CSRF protection is enabled globally" do
      Marten::Views::RequestForgeryProtectionSpec::TestView.protect_from_forgery?.should be_true
    end

    it "returns false if CSRF protection is disabled globally" do
      Marten.settings.csrf.protection_enabled = false
      Marten::Views::RequestForgeryProtectionSpec::TestView.protect_from_forgery?.should be_false
    end
  ...
  describe "#process_dispatch" do
    ...
    it "allows unsafe requests if CSRF protection is disabled and requests does not contain the CSRF token" do
      ...
      view = Marten::Views::RequestForgeryProtectionSpec::TestViewWithProtectionDisabled.new(request)
      response = view.process_dispatch
...
module Marten::Views::RequestForgeryProtectionSpec
  ...
  class TestViewWithTokenAccess < Marten::View
    include Marten::Views::RequestForgeryProtection
  ...
  class TestViewWithProtectionEnabled < Marten::View
    include Marten::Views::RequestForgeryProtection

    protect_from_forgery true
  end

  class TestViewWithProtectionDisabled < Marten::View
    include Marten::Views::RequestForgeryProtection
