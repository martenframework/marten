...
* Ensure subclasses of [`Marten::Conf::Setting`](pathname:///api/0.7/Marten/Conf/Settings.html) no longer have to define a mandatory `#initialize` method if they don't need to
