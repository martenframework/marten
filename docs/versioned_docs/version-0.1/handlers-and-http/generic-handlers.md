...
It is possible to use the [`Marten::Handlers::Schema`](pathname:///api/0.1/Marten/Handlers/Schema.html) generic handler in order to process form data with a [schema](../schemas.mdx).
