...
If you are trying to access the session store from within a view, it should be noted that you can leverage the `#session` method instead of using the request object:
