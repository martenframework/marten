...
You can disable this header on a per-handler basis by using the [`#exempt_from_x_content_type_options`](pathname:///api/0.7/Marten/Handlers/XContentTypeOptions/ClassMethods.html#exempt_from_x_content_type_options(exempt%3ABool)%3ANil-instance-method) class method.
