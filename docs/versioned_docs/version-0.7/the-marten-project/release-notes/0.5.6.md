...
* Make sure bound field [required state](pathname:///api/0.7/Marten/Schema/BoundField.html#required%3F(*args%2C**options)-instance-method) is exposed in templates.
