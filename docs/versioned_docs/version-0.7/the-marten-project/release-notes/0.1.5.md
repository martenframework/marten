...
* Ensure subclasses of [`Marten::Conf::Setting`](https://crystaldoc.info/github/martenframework/marten/v0.1.5/Marten/Conf/Settings.html) no longer have to define a mandatory `#initialize` method if they don't need to
