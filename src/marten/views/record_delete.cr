...
module Marten
  module Views
    ...
    #
    # This view can be used to delete an existing model record for POST requests. Optionally the view can be accessed
    # with GET request and a template can be displayed in this case; this allows to show a confirmation page to users
