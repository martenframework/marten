...
**Class**: [`Marten::Template::Loader::FileSystem`](pathname:///api/0.7/Marten/Template/Loader/FileSystem.html)
...
**Class**: [`Marten::Template::Loader::AppDirs`](pathname:///api/0.7/Marten/Template/Loader/AppDirs.html)
...
**Class**: [`Marten::Template::Loader::Cached`](pathname:///api/0.7/Marten/Template/Loader/Cached.html)
