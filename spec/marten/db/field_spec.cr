...
describe Marten::DB::Field do
  describe "#registry" do
    it "returns the expected field abstractions" do
      Marten::DB::Field.registry.size.should eq 23
      ...
      Marten::DB::Field.registry["decimal"].should eq Marten::DB::Field::Decimal
      ...
      Marten::DB::Field.registry["enum"].should eq Marten::DB::Field::Enum
      ...
      Marten::DB::Field.registry["image"].should eq Marten::DB::Field::Image
      ...
      Marten::DB::Field.registry["url"].should eq Marten::DB::Field::URL
